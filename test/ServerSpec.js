...
describe('', function() {
  ...
  beforeEach(function() {
    ...
    request('http://127.0.0.1:8080/logout', function(error, res, body) {});
  ...
  describe('Link creation:', function(){
    ...
    describe('Shortening links:', function(){
      ...
      it('Responds with the short code', function(done) {
        requestWithSession(options, function(error, res, body) {
          // console.log(res.body.url, res.body.code, "Stringasdfasd")
    ...
    describe('With previously saved urls:', function(){
      ...
      it('Shortcode redirects to correct url', function(done) {
        var options = {
          'method': 'GET',
          'uri': 'http://127.0.0.1:8080/' + link.get('code')
        };
  ...
  describe('Priviledged Access:', function(){
    ...
    it('Redirects to login page if a user tries to create a link and is not signed in', function(done) {
      request('http://127.0.0.1:8080/create', function(error, res, body) {
        expect(res.req.path).to.equal('/login');
        done();
      });
    });
    ...
    it('Redirects to login page if a user tries to see all of the links and is not signed in', function(done) {
      request('http://127.0.0.1:8080/links', function(error, res, body) {
        expect(res.req.path).to.equal('/login');
        done();
      });
    });
